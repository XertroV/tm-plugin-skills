...
- **Demo plugin** — A temporary/development Openplanet plugin used to compile, load, smoke, and visibly inspect skillpack snippets incrementally. Multiple demo plugins may isolate concerns; all use one dedicated skillpack-demo category.
